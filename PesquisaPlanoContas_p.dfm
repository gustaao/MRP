object PesquisaPlanoContas: TPesquisaPlanoContas
  Left = 0
  Top = 0
  Caption = 
    'MRP Com'#233'rcio - Sistema de Gerenciamento Comercial [Pesquisa Plan' +
    'o de Contas]'
  ClientHeight = 331
  ClientWidth = 713
  Color = clBtnFace
  ...
  object PanelPesquisa: TPanel
    ...
    object RadioGroupPesquisa: TRadioGroup
      ...
      Items.Strings = (
        'C'#243'digo'
        'C'#243'd. Cont'#225'bil'
        'Conta'
        'C'#243'digo Extendido')
      TabOrder = 2
      TabStop = True
    end
  end
  ...
  object cdsPlContas: TClientDataSet
    ...
    object cdsPlContasCODIGO_EXTENDIDO: TStringField
      DisplayLabel = 'C'#243'digo Extendido:'
