object TelaPedidoComprasConfirmaVencimento: TTelaPedidoComprasConfirmaVencimento
  Left = 288
  Top = 27
  BorderIcons = []
  ...
  object Label1: TLabel
    ...
    Align = alTop
    Alignment = taCenter
    Caption = 'ENTRADA PARA O FINANCEIRO (CONTAS A PAGAR)'
    Color = clYellow
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clRed
    Font.Height = -12
  ...
  object GroupBoxPrimeiro: TGroupBox
    ...
    object MaskeditDT11: TJvDateEdit
      Left = 57
      Top = 299
      Width = 89
      Height = 21
    ...
    object MaskEditVL11: TMaskEdit
      ...
      TabOrder = 22
      Text = '0,00'
      OnExit = MaskEditVL11Exit
      OnKeyPress = MaskEditVL5KeyPress
    end
    object MaskeditDT12: TJvDateEdit
      Left = 57
      Top = 325
      Width = 88
      Height = 21
    ...
    object MaskEditVL12: TMaskEdit
      ...
      TabOrder = 24
      Text = '0,00'
      OnExit = MaskEditVL12Exit
      OnKeyPress = MaskEditVL6KeyPress
    end
    object MaskeditDT13: TJvDateEdit
      Left = 57
      Top = 347
      Width = 89
      Height = 21
    ...
    object MaskEditVL13: TMaskEdit
      ...
      TabOrder = 26
      Text = '0,00'
      OnExit = MaskEditVL13Exit
      OnKeyPress = MaskEditVL1KeyPress
    end
    object MaskeditDT14: TJvDateEdit
      Left = 57
      Top = 373
      Width = 89
      Height = 21
    ...
    object MaskEditVL14: TMaskEdit
      ...
      TabOrder = 28
      Text = '0,00'
      OnExit = MaskEditVL14Exit
      OnKeyPress = MaskEditVL2KeyPress
    end
    object MaskeditDT15: TJvDateEdit
      Left = 57
      Top = 399
      Width = 88
      Height = 21
