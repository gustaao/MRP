object PesquisaSituacaoTributaria: TPesquisaSituacaoTributaria
  Left = 0
  Top = 0
  Caption = 
    'MRP Com'#233'rcio - Sistema de Gerenciamento Comercial [Pesquisa Situ' +
    'a'#231#227'o Tribut'#225'ria]'
  ClientHeight = 289
  ClientWidth = 724
  Color = clBtnFace
