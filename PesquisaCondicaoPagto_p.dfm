object PesquisaCondicaoPagto: TPesquisaCondicaoPagto
  Left = 0
  Top = 0
  Caption = 
    'MRP Com'#233'rcio - Sistema de Gerenciamento Comercial [Pesquisa Cond' +
    'i'#231#227'o de Pagamento]'
  ClientHeight = 289
  ClientWidth = 724
  Color = clBtnFace
  ...
  object cdsCondPagto: TClientDataSet
    ...
    Left = 675
    Top = 68
    object cdsCondPagtoCDCONDICAO_PAGTO: TIntegerField
    ...
    object cdsCondPagtoDDDPAGTO1: TIntegerField
      DisplayLabel = '1'#170' DDL:'
      FieldName = 'DDDPAGTO1'
    end
    object cdsCondPagtoDDDPAGTO2: TIntegerField
      DisplayLabel = '2'#170' DDL:'
      FieldName = 'DDDPAGTO2'
    end
    object cdsCondPagtoDDDPAGTO3: TIntegerField
      DisplayLabel = '3'#170' DDL:'
      FieldName = 'DDDPAGTO3'
    end
    object cdsCondPagtoDDDPAGTO4: TIntegerField
      DisplayLabel = '4'#170' DDL:'
      FieldName = 'DDDPAGTO4'
    end
    object cdsCondPagtoDDDPAGTO5: TIntegerField
      DisplayLabel = '5'#170' DDL:'
      FieldName = 'DDDPAGTO5'
    end
    object cdsCondPagtoDDDPAGTO6: TIntegerField
      DisplayLabel = '6'#170' DDL:'
      FieldName = 'DDDPAGTO6'
    end
    object cdsCondPagtoDDDPAGTO7: TIntegerField
      DisplayLabel = '7'#170' DDL:'
      FieldName = 'DDDPAGTO7'
    end
    object cdsCondPagtoDDDPAGTO8: TIntegerField
      DisplayLabel = '8'#170' DDL:'
      FieldName = 'DDDPAGTO8'
    end
    object cdsCondPagtoDDDPAGTO9: TIntegerField
      DisplayLabel = '9'#170' DDL:'
      FieldName = 'DDDPAGTO9'
    end
    object cdsCondPagtoDDDPAGTO10: TIntegerField
      DisplayLabel = '10'#170' DDL:'
      FieldName = 'DDDPAGTO10'
    end
    object cdsCondPagtoATIVO: TIntegerField
      DisplayLabel = 'Ativo'
      FieldName = 'ATIVO'
    end
  end
