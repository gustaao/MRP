object LivroCaixa: TLivroCaixa
  ...
  object qLCaixa: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'select *'
      'from livro_caixa'
      'order by cdlivro_caixa')
    SQLConnection = DMPrincipal.SQLCon
    Left = 1132
    Top = 204
    object qLCaixaCDLIVRO_CAIXA: TIntegerField
      FieldName = 'CDLIVRO_CAIXA'
      Required = True
    end
    object qLCaixaDATA: TDateField
      FieldName = 'DATA'
      Required = True
    end
    object qLCaixaMOTIVO_RAZAO: TStringField
      FieldName = 'MOTIVO_RAZAO'
      Required = True
      Size = 100
    end
    object qLCaixaCREDITO: TFMTBCDField
      FieldName = 'CREDITO'
      Precision = 18
      Size = 2
    end
    object qLCaixaDEBITO: TFMTBCDField
      FieldName = 'DEBITO'
      Precision = 18
      Size = 2
    end
    object qLCaixaSALDO: TFMTBCDField
      FieldName = 'SALDO'
      Precision = 18
      Size = 2
    end
    object qLCaixaCONTA_ORIGEM: TStringField
      FieldName = 'CONTA_ORIGEM'
      Size = 10
    end
    object qLCaixaCONTA_DESTINO: TStringField
      FieldName = 'CONTA_DESTINO'
      Size = 10
    end
    object qLCaixaDOCUMENTO: TStringField
      FieldName = 'DOCUMENTO'
      Size = 10
    end
    object qLCaixaLANCADO_POR: TStringField
      FieldName = 'LANCADO_POR'
      Size = 10
    end
    object qLCaixaLANCADO_EM: TDateField
      FieldName = 'LANCADO_EM'
    end
  end
  object cdsLCaixa: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspLCaixa'
    Left = 1132
    Top = 99
    object cdsLCaixaCDLIVRO_CAIXA: TIntegerField
      DisplayLabel = 'C'#243'digo'
      FieldName = 'CDLIVRO_CAIXA'
      Required = True
    end
    object cdsLCaixaDATA: TDateField
      DisplayLabel = 'Data'
      FieldName = 'DATA'
      Required = True
      EditMask = '00/00/0000;1;_'
    end
    object cdsLCaixaMOTIVO_RAZAO: TStringField
      DisplayLabel = 'Motivo/Raz'#227'o'
      FieldName = 'MOTIVO_RAZAO'
      Required = True
      Size = 100
    end
    object cdsLCaixaCREDITO: TFMTBCDField
      DisplayLabel = 'Cr'#233'dito'
      FieldName = 'CREDITO'
      Precision = 18
      Size = 2
    end
    object cdsLCaixaDEBITO: TFMTBCDField
      DisplayLabel = 'D'#233'bito'
      FieldName = 'DEBITO'
      Precision = 18
      Size = 2
    end
    object cdsLCaixaSALDO: TFMTBCDField
      DisplayLabel = 'Saldo'
      FieldName = 'SALDO'
      Precision = 18
      Size = 2
    end
    object cdsLCaixaCONTA_ORIGEM: TStringField
      DisplayLabel = 'Conta Origem'
      FieldName = 'CONTA_ORIGEM'
      Size = 10
    end
    object cdsLCaixaCONTA_DESTINO: TStringField
      DisplayLabel = 'Conta Destino'
      FieldName = 'CONTA_DESTINO'
      Size = 10
    end
    object cdsLCaixaDOCUMENTO: TStringField
      DisplayLabel = 'N'#186' Doc.'
      FieldName = 'DOCUMENTO'
      Size = 10
    end
    object cdsLCaixaLANCADO_POR: TStringField
      DisplayLabel = 'usuario'
      FieldName = 'LANCADO_POR'
      Size = 10
    end
    object cdsLCaixaLANCADO_EM: TDateField
      DisplayLabel = 'Data'
      FieldName = 'LANCADO_EM'
    end
  end
  object dspLCaixa: TDataSetProvider
    DataSet = qLCaixa
    Options = [poAllowCommandText, poUseQuoteChar]
    Left = 1133
    Top = 150
  end
  object dsLCaixa: TDataSource
    DataSet = cdsLCaixa
    Left = 1133
    Top = 45
  end
