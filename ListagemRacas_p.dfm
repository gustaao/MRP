object ListagemRacas: TListagemRacas
  Left = 0
  Top = 0
  Caption = 'ListagemRacas'
  ClientHeight = 363
  ClientWidth = 1015
  Color = clBtnFace
  ...
  object cdsRaca: TClientDataSet
    ...
    Left = 76
    Top = 147
    object cdsRacaCDRACA: TIntegerField
      DisplayLabel = 'C'#243'digo:'
      FieldName = 'CDRACA'
      Required = True
    end
    object cdsRacaDESCRICAO: TStringField
      DisplayLabel = 'Ra'#231'a:'
      FieldName = 'DESCRICAO'
      Size = 30
    end
    object cdsRacaCADASTRADO_POR: TStringField
      DisplayLabel = 'Usu'#225'rio:'
      FieldName = 'CADASTRADO_POR'
      Size = 35
    end
    object cdsRacaCADASTRADO_EM: TSQLTimeStampField
      FieldName = 'CADASTRADO_EM'
      EditMask = '00/00/0000;1;_'
    end
    object cdsRacaALTERADO_POR: TStringField
      DisplayLabel = 'Usu'#225'rio (Altera'#231#227'o):'
      FieldName = 'ALTERADO_POR'
      Size = 35
    end
    object cdsRacaALTERADO_EM: TSQLTimeStampField
